...
pub const OpenApi31Document = struct {
    ...
    pub fn deinit(self: *OpenApi31Document, allocator: std.mem.Allocator) void {
    ...
    pub fn parseFromJson(allocator: std.mem.Allocator, json_string: []const u8) anyerror!OpenApi31Document {
